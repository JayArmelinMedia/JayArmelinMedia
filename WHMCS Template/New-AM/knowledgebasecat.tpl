<div class="subheadingbox">
    <div class="Inner-box">
        {if $LANG.knowledgebasetitle}<h2><i class="fas fa-info-circle fa-fw"></i>{$LANG.knowledgebasetitle}</h2>{/if}
    </div>
</div>
...
<a href="javascript:history.go(-1)" class="btn btn-default px-4 back-btn">

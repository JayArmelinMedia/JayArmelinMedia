<div class="subheadingbox">
    <div class="Inner-box">
        {if $LANG.announcementstitle}<h2><i class="fas fa-list fa-fw"></i>{$LANG.announcementstitle}</h2>{/if}
        {if $LANG.announcementsdescription}<p>{$LANG.announcementsdescription}</p>{/if}
    </div>
</div>
